        ...
        <main className="profile-content">
          ...
          <section className="profile-section">
            ...
            <p>
              ...
              <a href={"https://www.linkedin.com/in/sudipta-mukherjee-19295a248/"} target="_blank" rel="noopener noreferrer">
                {"linkedin"}
              </a>
            </p>
            <p>
              <strong>GitHub:</strong>{" "}
              <a href={"https://github.com/sudiptaMukherjee2001"} target="_blank" rel="noopener noreferrer">
                {"github"}
              </a>
            </p>
            {/*-----------------------------------------------------  end -----------------------------------------------------*/}
